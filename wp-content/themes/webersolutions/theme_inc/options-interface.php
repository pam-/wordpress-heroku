...
function optionsframework_fields() {
	...
	foreach ( $options as $value ) {
		...
		case 'background':
			...
			//$output .= '<select class="of-background of-background-position" name="' . esc_attr( $option_name . '[' . $value['id'] . '][effect]' ) . '" id="' . esc_attr( $value['id'] . '_effect' ) . '">';
			//$effects = array("fade","scrollHorz","fadeout","scrollUp","shuffle-left","toss");

			//foreach ($effects as $key=>$effect) {
				//$output .= '<option value="' . esc_attr( $key ) . '" ' . selected( $background['effect'], $key, false ) . '>'. esc_html( $effects ) . '</option>';
			//}
			//$output .= '</select>';
