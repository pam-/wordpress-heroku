...
?>
	...
	<h2 class="page-title"><?php _e( 'Nothing Found', 'ssxtheme' ); ?></h2>
...
<div class="page-content">
	...
	<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with different keywords.', 'ssxtheme' ); ?></p>
	<?php // get_search_form(); ?>
